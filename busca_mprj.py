...
def extrair_dados_com_ia(texto_relevante):
    try:
        ...
        prompt = f'''
        Analise o texto e extraia vagas de CONCURSO DE REMOÇÃO PARA PROMOTOR DE JUSTIÇA.
        Localize a seção específica e extraia: Item; Órgão; Critério; Origem da Vaga.
        Ignore Procuradores ou Promoções simples.
        Saída: Item;Órgão;Critério;Origem da Vaga
        Se nada, retorne: VAZIO
